...
module.exports = (app) => {
  ...
  <body>
    ...
    <buttom><a href="/livros">Livros</a></buttom>
  </body>
  </html>`
        );
    });
    ...
    // app é o objeto do express - function() é o callback
    ...
    app.get('/livros/form/:id', function(req, resp) {
        ...
        livroDao.buscaPorId(id)
            .then(livro => resp.marko(
                require('../views/livros/form/form.marko'), { livro })).catch(erro => console.log(erro));
    });
